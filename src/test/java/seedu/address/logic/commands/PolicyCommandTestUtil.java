...
public class PolicyCommandTestUtil {
    ...
    public static final String POLICY_ID_DESC_HOME = " " + PREFIX_PID + VALID_POLICY_ID_HOME;
    public static final String POLICY_ID_DESC_HEALTH_B = " " + PREFIX_PID + VALID_POLICY_ID_HEALTH_B;
    ...
    public static final String INVALID_POLICY_ID = "invalid id";
    public static final String INVALID_POLICY_ID_DESC = " " + PREFIX_PID + INVALID_POLICY_ID;
