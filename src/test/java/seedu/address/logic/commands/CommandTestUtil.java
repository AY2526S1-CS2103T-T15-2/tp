...
public class CommandTestUtil {
    ...
    public static final String INVALID_NRIC_DESC = " " + PREFIX_NRIC + "a9110302a"; // 'a' not allowed to start nric
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withNric(VALID_NRIC_AMY).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withNric(VALID_NRIC_AMY).withEmail(VALID_EMAIL_BOB)
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        final String[] splitName = person.getNric().nric.split("\\s+");
        model.updateFilteredPersonList(new NricContainsKeywordsPredicate(Arrays.asList(splitName[0])));
