...
|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Phone**         | A string of characters that contain an optional starting +, numbers, dashes, and spaces. It should contain at least 3 numbers, and have at most 30 characters. e.g `999` `98765321` `+65-9722-9120`                                                                                                                                                                                                                                                                                                            |
...
| **Address**       | A string that contains [printable ASCII characters](#glossary) e.g `110 Raffles Street, #06-12`                                                                                                                                                                                                                                                                                                                                                                                                                |
