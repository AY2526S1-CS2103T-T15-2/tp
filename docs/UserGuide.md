...
| **Email**              | A string that follows **local-part@domain**. The local-part should only contain alphanumeric characters and these special characters, excluding (+_.-). The domain name is made up of domain labels separated by periods. The domain name must: end with a domain label at least 2 characters long, have each domain label start and end with alphanumeric characters, have each domain label consist of alphanumeric characters, separated only by hyphens, if any. |
| **ContractId**         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **AppointmentId**      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 
| **PolicyId**           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Premium**            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
